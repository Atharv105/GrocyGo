  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Book and manage your grocery pickup times.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 flex flex-col items-center text-center">
        ...
        <p className="text-gray-400 mt-2 max-w-sm">
          Once available, you can book convenient pickup slots here and avoid waiting in queues.
        </p>
